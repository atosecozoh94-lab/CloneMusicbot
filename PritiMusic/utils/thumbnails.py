...
# Constants & Paths
CACHE_DIR = "cache"
ASSETS_DIR = "PritiMusic/assets" # ✅ Fixed path to match your bot
...
# ✅ Added Fallback Helper to prevent bot crashes
...
# ✅ Added player_username parameter to match old signature
async def get_thumb(videoid: str, player_username: str = None) -> str:
    ...
    try:
        ...
        try:
            ...
            # Safe image URL fetch
            thumbnail = data.get("thumbnails", [{}])[0].get("url")
            if not thumbnail:
                thumbnail = get_random_fallback_img()
