...
# ✅ Reverted to your bot's exact imports
from PritiMusic import app
from config import YOUTUBE_IMG_URL

CACHE_DIR = "cache"
ASSETS_DIR = "PritiMusic/assets" # ✅ Fixed path

os.makedirs(CACHE_DIR, exist_ok=True)

# ✅ Kept your fallback helper to prevent bot crashes
...
def make_progress_time(duration: str):
    if not duration or ":" not in str(duration):
        return "00:00", "03:00"
    return "00:00", str(duration) # Changed "00:25" to "00:00" to look realistic
...
# ✅ Main function updated with Safe Try-Catch Block
async def get_thumb(videoid: str, player_username: str = None) -> str:
    # 1. Quick Cache Return to avoid processing twice
    ...
    try:
        ...
        # Return fallback URL gracefully if anything crashes
